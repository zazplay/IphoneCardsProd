...
import { StyledCompsWrapper, NormalPriceCard, ImgPhone, Star, NewStick, HeartContainer, ScalesContainer, ColorsContainer, Color1, Color2, Color3, Color4, ContainerMemory, MemoryStick, ProductTit, ProductNumber, StarsContainer, Reviews, PriceContainer, NewPrice, OldPrice, BuyBtn } from './StyledComps2.styled.ts';
